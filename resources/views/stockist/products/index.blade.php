            ...
            <div class="card-body p-0">
                ...
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Manage Prodct</h1>
                    </div>
...
@section('script')
    ...
    <script>
        var table = $('.dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{route('stockist.products.index',['datatable'=>true])}}',
            columns: [
        ...
        function Assign(id,q){
            $.confirm({
                ...
                content: '' +
                    ...
                    '<select  class="name form-control" required >@foreach ($stockists as $stockist) <option value="{{$stockist->id}}">{{$stockist->name}}</option> @endforeach</select>' +
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function () {
                            ...
                            $.get('{{route('admin.products.index')}}?id='+id+'&user_id='+name+'&quantity='+quantity,function(resp){
